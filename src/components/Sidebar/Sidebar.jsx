...
const Sidebar = () => {
  ...
  const activeLink =
    "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md m-2 bg-gray-800";
  const normalLink =
        ...
        <>
          <div className="flex justify-between items-center">
            <Link
              ...
              className="items-center flex justify-center gap-3 ml-3 mt-4 text-xl font-extrabold tracking-tight dark:text-white text-slate-900"
            >
